...
public class SalesOrderItemEntity {
    ...
    public void calculateLineTotals() {
        ...
        if (discountType == null) discountType = SalesOrderDiscountType.NONE;
        ...
        if (discountType == SalesOrderDiscountType.PERCENTAGE) {
            discountAmount = amount
                    .multiply(discountValue)
                    .divide(BigDecimal.valueOf(100), 2, RoundingMode.HALF_UP);
        } else if (discountType == SalesOrderDiscountType.DIRECT_PRICE_REDUCTION) {
        ...
        if (taxType == SalesOrderTaxType.NONE) {
