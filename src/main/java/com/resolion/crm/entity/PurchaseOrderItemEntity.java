...
public class PurchaseOrderItemEntity {
    ...
    public void calculateLineTotals() {
        ...
        if (discountType == null) discountType = PurchaseOrderDiscountType.NONE;
        ...
        } else if (discountType == PurchaseOrderDiscountType.DIRECT_PRICE_REDUCTION) {
        ...
        if (taxType == PurchaseOrderTaxType.NONE) {
